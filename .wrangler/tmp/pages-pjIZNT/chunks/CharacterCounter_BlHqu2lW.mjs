...
import { j as jsxRuntimeExports, a as cn, d as cva, S as Slot } from './client_DXxObFE8.mjs';
import { a as reactExports, R as React } from './_@astro-renderers_D9WLdofW.mjs';
...
function CharacterCounter({ current, min, max }) {
  const isValid = reactExports.useMemo(() => current >= min && current <= max, [current, min, max]);
...
export { CharacterCounter as C, Form as F, Label as L, Textarea as T, a, FormField as b, FormItem as c, FormLabel as d, FormControl as e, FormMessage as f, useWatch as g, useForm as u };
